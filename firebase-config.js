/* ==========================================================================
   ...
   7. Build → Storage → Get started → keep default settings → Done.
      (This is where item photos will be stored.) Then go to the Storage
      Rules tab and paste the storage rules from README.md → Publish.
   ========================================================================== */
